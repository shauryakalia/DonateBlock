...
componentWillMount() {
  BackendServices.getVendorWallet(sessionStorage.getItem('token'))
  .then(res => {
    console.log(res.message.wallet._id)
    this.setState({
        walletAddress: res.message.wallet.vendorWalletAddress,
        pvtKey: res.message.wallet.vendorPrivateKey,
        pubKey: res.message.wallet.vendorPublicKey,
    })
}, error => {
    console.log(error)
    }
  ...
  render() {
    ...
    return (
      ...
      <Paper className={classes.paper}>
        <Typography variant="h5" align="center" style={{marginBottom: 30}}> <u>VENDOR WALLET</u></Typography>
