...
componentWillMount() {
  BackendServices.getUserWallet(sessionStorage.getItem('token'))
  .then(res => {
    console.log(res.message.wallet._id)
    this.setState({
        walletAddress: res.message.wallet.walletAddress,
        pvtKey: res.message.wallet.privateKey,
        pubKey: res.message.wallet.publicKey,
    })
}, error => {
    console.log(error)
    }
  ...
  render() {
    ...
    return (
      ...
      <Paper className={classes.paper}>
        <Typography variant="h5" align="center" style={{marginBottom: 30}}> <u>USER WALLET</u></Typography>
